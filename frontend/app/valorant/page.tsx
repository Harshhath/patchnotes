...
function ValorantLogo({ size = 22 }: { size?: number }) {
  return <Image src="/valorant-logo1.png" alt="Valorant Logo" width={size} height={size} priority />
}
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7,1fr)', gap: 2 }}>
        {cells.map(({ date, current }, i) => {
          ...
          if (isSelected) { bg = ACCENT; color = '#fff'; border = `1px solid ${ACCENT}`; fontWeight = 700 }
      ...
      <header className="relative z-20 border-b"
        ...
        <div className="max-w-7xl mx-auto px-8 py-5">
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[10px] font-bold tracking-[0.25em] uppercase" style={{ color: ACCENT }}>Valorant</span>
          </div>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      color: active ? '#ff8a93' : 'rgba(255,255,255,0.45)',
                    }}
                    onMouseEnter={(e) => {
                      if (active) return
              ...
              <a key={patch.id} href={patch.url} target="_blank" rel="noopener noreferrer" className="block group">
                <div className="relative rounded-xl border p-5 transition-all duration-200 overflow-hidden cursor-pointer"
                  ...
                  <div className="absolute left-0 top-0 bottom-0 w-[3px] rounded-l-xl opacity-0 group-hover:opacity-100 transition-opacity"
                    style={{ background: `linear-gradient(to bottom, ${ACCENT}, #bd3944)` }} />
